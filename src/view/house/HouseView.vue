...
<template>
  <div
    class="bg-cream backr bg-white"
    :style="{
      backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('https://dweltimmo.net/wp-content/uploads/2025/07/IMG-20250702-WA0203-592x444.jpg')`,
    }"
  >
    <div class="max-w-screen-xl p-8 mb-8 mx-auto flex flex-col lg:flex-row items-start">
      <!--Left Col-->
      <div
        class="flex flex-col w-full lg:w-6/10 justify-center lg:pt-12 items-start text-center lg:text-left mb-5 md:mb-0"
      >
        <h1
          data-aos="fade-right"
          data-aos-once="true"
        ...
        >
          <span class="text-white">L’agence immobilière nouvelle génération</span>
        </h1>
        <p
          data-aos="fade-down"
          data-aos-once="true"
        ...
        >
          qui révolutionne le marché. Grâce à une expertise pointue et une approche innovante, elle
          accompagne ses clients dans tous leurs projets pour assurer leur réussite. Les pros de
          l’immo.
        </p>
        <div
          data-aos="fade-up"
          data-aos-once="true"
          data-aos-delay="700"
          class="w-full p-8 md:flex items-center justify-center lg:justify-start md:space-x-5"
        >
          <button
      ...
      <div class="w-full lg:w-6/12 lg:mt-2 relative" id="girl">
        <!-- <div
          class="bg-yellow-500 w-5 h-5 rounded-full absolute z-0 rigth-100 top-12 animate-ping"
        ></div> -->
        <!-- <div style="background: #23BDEE;" class="floating w-24 h-24 absolute rounded-lg z-0 -top-3 -left-3"></div> -->
        <!-- <div style="background: #23BDEE;" class="floating w-24 h-24 absolute rounded-lg z-0 -top-3 -left-3"></div> -->
        <div
          class="w-5 h-5 rounded-full bg-red-300 animate-ping floating absolute z-10 -top-3 -right-3"
        ></div>
        <div
          style="background: #23bdee"
          class="floating w-5 h-5 absolute rounded-full z-0 -top-3 -left-3 animate-ping"
        ></div>
        <img class="rounded-xl z-40 relative" src="https://pngimg.com/d/house_PNG50.png" alt="" />
        <div
          class="bg-yellow-500 w-5 h-5 animate-ping rounded-full floating absolute z-10 -bottom-3 -right-3"
        ></div>
        <!-- <div class="bg-yellow-500 w-40 h-40 floating absolute rounded-lg z-10 -bottom-3 -right-3"></div> -->
        <!-- <img data-aos="fade-up" data-aos-once="true" class="w-12/12 mx-auto 2xl:-mb-20" src="../assets/images/backgrounds/mapcolor.png" />  -->
    ...
    <div class="text-gray-900 -mt-14 sm:-mt-24 lg:-mt-36 z-40 relative">
      <!-- <defs>
      ...
      <div class="bg-gray-900 w-full h-20 -mt-px"></div>
    </div>
  </div>
  <div class="container px-4 lg:px-8 mx-auto max-w-screen-xl text-gray-700 overflow-x-hidden">
    <div data-aos="flip-up" class="max-w-xl mx-auto text-center mt-24">
      <h1 class="font-bold text-darken my-3 text-2xl">
        Pourquoi dwelt est un meilleur choix dans l'immobilier ?
      </h1>
      <p class="leading-relaxed text-gray-500"></p>
    </div>
    <!-- card -->
    <div class="grid md:grid-cols-3 gap-14 md:gap-5 mt-20">
      <div data-aos="fade-up" class="bg-white shadow-xl p-6 text-center rounded-xl">
        ...
        <h1 class="font-medium text-xl mb-3 lg:px-14 text-darken">Transparence et confiance</h1>
        <p class="px-4 text-gray-500">
          Dwelt place la transparence au cœur de ses services, en fournissant des informations
          claires et fiables à chaque étape. Avec nous, aucune mauvaise surprise : tout est pensé
      ...
      >
        ...
        <h1 class="font-medium text-xl mb-3 lg:px-14 text-darken">
          Innovation pour simplifier l'immobilier
        </h1>
        <p class="px-4 text-gray-500">
          Grâce à des outils technologiques modernes et des processus simplifiés, Dwelt rend vos
          démarches immobilières rapides et efficaces. Vous gagnez du temps tout en bénéficiant
          d’une expérience fluide et professionnelle
        </p>
      </div>
      <div
        data-aos="fade-up"
      ...
      >
        ...
        <h1 class="font-medium text-xl mb-3 lg:px-14 text-darken lg:h-14">
          Solutions personnalisées
        </h1>
        <p class="px-4 text-gray-500">
          Chaque projet est unique, et Dwelt le comprend parfaitement. Nous adaptons nos stratégies
          et accompagnons nos clients avec une approche sur mesure qui tient compte de leurs besoins
          et ambitions.
        </p>
      </div>
    </div>
    ...
    <div class="mt-24 flex flex-col md:flex-row items-start md:space-x-10">
      ...
      <div data-aos="zoom-in-left" class="md:w-6/12">
        ...
        <h1 class="font-semibold text-darken text-2xl lg:pr-40">
          200+ educational tools and platform <span class="text-yellow-500">integrations</span>
        </h1>
        <p class="text-gray-500 my-5 lg:pr-20">
          Schoology has every tool your classroom needs and comes pre-integrated with more than 200+
          tools, student information systems (SIS), and education platforms.
        </p>
        <button
          class="px-5 py-3 border border-yellow-500 text-yellow-500 font-medium my-4 focus:outline-none transform transition hover:scale-110 duration-300 ease-in-out rounded-full"
        >
    ...
    <div class="mt-24 flex flex-col-reverse md:flex-row items-start md:space-x-10">
      <div data-aos="zoom-in-right" class="md:w-5/12">
        ...
        >
          ...
          <div
            class="border border-yellow-500 h-14 w-14 rounded-full flex items-center justify-center"
          >
